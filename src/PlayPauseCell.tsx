...
const PlayPauseCell: React.FC<PlayPauseCellProps> = ({
  value = true,
  size = "md",
  className,
  style,
  ...
  return (
    <div className={`precooked-play-pause-cell-container ${className}`} style={{ ...style }}>
      {processing ? (
        <div
          style={{
            paddingTop: 5,
